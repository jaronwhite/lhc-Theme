...
include( 'C:\wamp64\www\wpdev\wp-admin\includes\class-walker-nav-menu-edit.php' );
 ...
 */
class WalkingTheAdminDog extends Walker_Nav_Menu_Edit {
	/**
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
        ...
        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
			...
			<?php
			/**
			 * THis is where the special menu stuff lives.
			 */
			if ( $depth == 0 ) {
				?>
                <p class="field-custom description">
                    <label for="edit-menu-item-submenu-<?php echo $item_id; ?>">
                        <input type="checkbox" id="edit-menu-item-submenu-<?php echo $item_id; ?>" value="submenu"
                               name="menu-item-submenu[<?php echo $item_id; ?>]"<?php checked( $item->submenu, 'submenu' ); ?> />
						<?php _e( 'Image Submenu' ); ?>
                    </label>
                </p>
				<?php
			}
